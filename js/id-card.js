...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (createIdButton) {
        ...
        createIdButton.addEventListener('click', function() {
            ...
            if (idCardModal) {
                ...
                console.error('No se encontró el modal de cédula');
            }
        });
    } else {
    ...
    if (photoInput) {
                ...
                try {
                    ...
                    reader.onload = function(e) {
                        if (photoPreview) {
                            ...
                            console.log('Vista previa de foto actualizada');
                        } else {
                            console.error('No se encontró el elemento photoPreview');
                        }
                    };
        ...
        console.log('No se encontró el input de foto en esta página');
    }
    ...
    // Calcular edad basada en la fecha de nacimiento
    // Mover la declaración de funciones fuera del event listener
    function calculateAge(birthDateString) {
        const today = new Date();
        const birthDate = new Date(birthDateString);
        let age = today.getFullYear() - birthDate.getFullYear();
