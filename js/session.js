document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateNavForLoggedInUser(user) {
        ...
        // Si encontramos el contenedor de botones de autenticación, reemplazarlo con perfil de usuario
        if (authButtons) {
            ...
            userProfileElement.innerHTML = `
                <div class="user-avatar">
                    <img src="imgs/user-avatar.png" alt="Avatar de Usuario" onerror="this.src='https://ui-avatars.com/api/?name=${encodeURIComponent(user.robloxName)}&background=9c27b0&color=fff'">
                </div>
                <div class="user-info">
